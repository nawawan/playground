...
const meta = {
  title: "Trajectory/Components/ImagePanel",
...
const InteractiveImagePanel = () => {
  const activity = trajectoryActivities[1];
...
export const Default: Story = {
  args: {
    activePhotoId: trajectoryActivities[1].photos[0]?.id ?? null,
    activity: trajectoryActivities[1],
    here: trajectoryActivities[1].photos[0]?.at ?? 0.52,

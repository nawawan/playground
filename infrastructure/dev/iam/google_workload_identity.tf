...
resource "google_iam_workload_identity_pool_provider" "nawawan_dev_github_provider" {
  ...
  workload_identity_pool_provider_id = "github-dev-reader"
...
resource "google_iam_workload_identity_pool_provider" "nawawan_dev_github_provider_editor" {
  workload_identity_pool_id          = google_iam_workload_identity_pool.nawawan_dev_pool.workload_identity_pool_id
  workload_identity_pool_provider_id = "github-dev-editor"
...
resource "google_service_account_iam_member" "nawawan_dev_reader_member" {
  service_account_id = data.google_service_account.nawawan_dev_reader.name
...
resource "google_service_account_iam_member" "nawawan_dev_editor_member" {
  service_account_id = data.google_service_account.nawawan_dev_editor.name
  role               = "roles/iam.workloadIdentityUser"
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.nawawan_dev_pool.name}/attribute.repository/nawawan/playground"
}
